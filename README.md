...
私は現在、フリー株式会社にて Web アプリケーション開発エンジニアとして勤務しています。
大学院では、統計的機械学習に基づく、神経システムの推定をテーマとして研究していました。
...
お仕事では、Ruby on Rails, React, terraform (AWS) を用いています。
...
| 神戸大学 大学院 工学研究科 電気電子工学専攻 | 2022年 4月 ~ 2024年3月  | 学位: 修士(工学)       |
| フリー株式会社                              | 2024年 4月 ~            | フルスタックエンジニア |
